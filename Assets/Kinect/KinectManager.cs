...
//	}
    ...
    public byte[] GetUsersClrByte()
    {
        //return usersClrTex;
        return sensorData != null ? sensorData.colorImage : null;
    }
...
//		}
	...
	void Awake()
	{
		...
		instance = this;
        computeUserMap = UserMapType.UserTexture;
        computeColorMap = true;
...
//			}
    ...
    protected virtual void CalibrateUser(Int64 userId, int bodyIndex)
    {
		if(!alUserIds.Contains(userId))
		{
			if(CheckForCalibrationPose(userId, bodyIndex, playerCalibrationPose))
			{
                ...
                //gsm fixed
                //KINECTManager.Instance.FindUser?.Invoke(userId);
	...
	protected virtual void RemoveUser(Int64 userId)
	{
        ...
        //gsm fixed 
        //KINECTManager.Instance.LoseUser?.Invoke(userId);
